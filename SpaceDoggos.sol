...
contract SpaceDoggos {
    ...
    function createDoggo(string _name, uint8 _breed, uint8 _color, uint8 _face, uint8 _costume) private {
    ...
    function getSystemMap(uint _coordX, uint _coordY) private pure returns (uint) {
